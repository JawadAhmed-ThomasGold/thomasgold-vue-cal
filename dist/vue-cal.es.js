...
var H = (e, t, i) => (re(e, typeof t != "symbol" ? t + "" : t, i), i);
...
const ve = { class: "vuecal__flex vuecal__weekdays-headings" }, me = ["onClick"], pe = { class: "vuecal__flex weekday-label", grow: "" }, we = { class: "full" }, De = { class: "small" }, ye = { class: "xsmall" }, ge = { key: 0 }, fe = { key: 0, class: "vuecal__flex vuecal__split-days-headers", grow: "" }, B = (e, t) => {
  ...
  return this.modules.dnd;
} } }, He = ["data-split", "aria-label", "onTouchstart", "onMousedown", "onDragover", "onDrop"], We = { key: 0, class: "cell-time-labels" }, Ve = ["innerHTML"], Ae = { key: 2, class: "vuecal__cell-events" }, je = ["title"], ae = B({ inject: ["vuecal", "utils", "modules", "view", "domEvents"], components: { Event: B(xe, [["render", function(e, t, i, n, l, s) {
  ...
  return h(), c("div", { class: "vuecal__flex vuecal__all-day", style: $(i.cellOrSplitMinWidth && { height: i.height }) }, [i.cellOrSplitMinWidth ? v("", !0) : (h(), c("div", Ye, [k("span", null, f(i.label), 1)])), k("div", { class: b(["vuecal__flex vuecal__cells", `${s.view.id}-view`]), grow: "", style: $(i.cellOrSplitMinWidth ? `min-width: ${i.cellOrSplitMinWidth}px` : "") }, [(h(!0), c(T, null, S(i.cells, (a, d) => (h(), W(o, { key: d, options: i.options, "edit-events": s.editEvents, data: a, "all-day": !0, "cell-width": i.options.hideWeekdays.length && (s.vuecal.isWeekView || s.vuecal.isMonthView) && s.vuecal.cellWidth, "min-timestamp": i.options.minTimestamp, "max-timestamp": i.options.maxTimestamp, "cell-splits": i.daySplits }, { event: g(({ event: r, view: u }) => [w(e.$slots, "event", { view: u, event: r })]), _: 2 }, 1032, ["options", "edit-events", "data", "cell-width", "min-timestamp", "max-timestamp", "cell-splits"]))), 128))], 6)], 4);
