...
div
  ...
  ul.api-options
    ...
    li
      code.mr2 dragToCreateThreshold
    ...
    li
      code.mr2 disableDatePrototypes
      span.code [Boolean], default: false
      p.
